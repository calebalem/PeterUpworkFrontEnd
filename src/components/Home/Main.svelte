    ...
    <nav>
        ...
        >
            <div class="flex-none  lg:flex">
                <label for="my-drawer-2" class="btn btn-square btn-ghost drawer-button" on:click={hello}>
                    <Menu24 />
                </label>
            </div>
            ...
            <div class="drawer-side">
                ...
                >
                    <li>
                       ...
                       <Link to="dashboard"><Dashboard24 class="mr-2"/><label for="my-drawer-2" class="drawer-button">DashBoard</label></Link>
                    </li>
                    <li>
                        <Link to="maindataentry"> <Database24 class="mr-2"/><label for="my-drawer-2" class="drawer-button">Data Entry</label></Link>
                    </li>
                    <li>
                       <Link to="calander"> <CalendarHeatMap24 class="mr-2"/>  <label for="my-drawer-2" class="drawer-button">Calander</label></Link>
                    </li>
                </ul>
            </div>
        </div>
